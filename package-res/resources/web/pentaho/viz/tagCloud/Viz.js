...
define([
    ...
    'dojo/_base/lang',
    'cdf/lib/CCC/tipsy'
], function(vizUtils, VizController, pv, LayoutCloud, lang) {
    ...
    */
    ...
    TagCloud.prototype.colortextChanged = function(value) {
    ...
    TagCloud.prototype.colorSetChanged = function(value) {
        this.colorSet = value;
    ...
    TagCloud.prototype.patternChanged = function(value) {
        this.pattern = value;
    ...
    TagCloud.prototype.reverseColorsChanged = function(value) {
    ...
    TagCloud.prototype.getState = function() {
        if(this.debug) console.log('TagCloud.getState()');
        var state = {
    ...
    TagCloud.prototype.setState = function(state) {
        if(this.debug) console.log('TagCloud.setState()');
    ...
    */
    TagCloud.prototype.draw = function(pdataTable, options) {
    ...
    TagCloud.prototype.getColor = function(d) {
        ...
        if(this.colorCol == -1) {
            ...
            try {
                color = vizUtils.getRgbGradientFromMultiColorHex(d.colorValue, this.minColor, this.maxColor, this.colorRange);
