...
define([
    ...
    "css!./crossFilter",
    "css!../table"
], function(vizUtils, vizColorPaletteRegistry, vizEvents, d3, D3CrossFilter, lang, Messages) {
    ...
    */
    function CrossFilter(element) {
        ...
        this.selectionList = [];
        this.showTable = true;
        this.barColor = vizColorPaletteRegistry.get("twelveDaysViz").colors[0];
    }

    // return the state of this visualization for persistance/back-one etc
    CrossFilter.prototype.getState = function() {
        if(this.debug) console.log('CrossFilter.getState()');
        var state = {
    ...
    CrossFilter.prototype.setState = function(state) {
        if(this.debug) console.log('CrossFilter.setState()');
        this.showTable = state.showTable;
    };

    CrossFilter.prototype.showTableChanged = function(value) {
    ...
    */
    CrossFilter.prototype.draw = function(pdataTable, vizOptions) {
        ...
        vizUtils.handleCommonOptions(this, vizOptions);

        vizUtils.applyBackground(this.element, vizOptions);
        ...
        var chartsPerRow = Math.floor(vizUtils.getClientWidth(this) / 350);
        ...
        center.appendChild(table);
        if(this.showTable) {
            vizUtils.createSelectionTable(table, this.dataTable, this.labelFontStr, this.labelColor, lang.hitch(this, this.setSort));
        }
    ...
    CrossFilter.prototype.barChart = function(id, vis) {
      ...
      CrossFilter.prototype.updateTable = function(div) {
        ...
        if(this.showTable) {
            ...
            vizUtils.updateSelectionTable(table, this.dataTable, data, this.labelFontStr, this.labelColor);
        }
    };
