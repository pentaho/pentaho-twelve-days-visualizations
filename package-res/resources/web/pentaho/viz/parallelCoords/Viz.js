...
define([
    ...
    "cdf/lib/CCC/tipsy",
    "css!../table"
], function(vizUtils, vizColorPaletteRegistry, vizEvents, pv, $, lang, Messages) {
    ...
    function ParallelCoords(div) {
        ...
        this.highlight = function() {
            if(this.debug) console.log('ParallelCoords.highlight()');
        };


        // return the state of this visualization for persistance/back-one etc
        this.getState = function() {
            if(this.debug) console.log('ParallelCoords.getState()');
            var state = {
        ...
        this.setState = function(state) {
            if(this.debug) console.log('ParallelCoords.setState()');
        ...
        this.draw = function(dataTable, options) {
            ...
            if(this.showTable) {
                vizUtils.createSelectionTable(this.table, dataTable, this.labelFontStr, this.labelColor);
            }
        ...
        this.resize = function() {
            ...
            if(this.showTable) {
                ...
                this.h = Math.floor((vizUtils.getClientHeight(this))*.66);
                this.tableDiv.style.top = ""+(this.h+400)+"px";
            } else {
                this.w = vizUtils.getClientWidth(this)-20;
                this.h = vizUtils.getClientHeight(this)-20;
            }
        ...
        this.update = function() {
            if(this.debug) console.log('ParallelCoords.update()');
            this.mouseDown = true;
        };
    ...
    //        this.svgDiv.style.overflow="hidden";
        ...
        this.updateSelections = function() {
            ...
            if(this.selections.length == 0) {
                ...
                vizUtils.updateSelectionTable(this.table, this.dataTable, this.selections, this.labelFontStr, this.labelColor);
                return;
            }
