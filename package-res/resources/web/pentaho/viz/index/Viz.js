...
define([
...
], function(vizUtils, vizColorPaletteRegistry, pv, Messages) {
    ...
    function Index(div) {
        ...
        if(this.debug) console.log('Index.create');
        ...
        this.draw = function(dataTable, options) {
            ...
            this.w = vizUtils.getClientWidth(this);
            this.h = vizUtils.getClientHeight(this);
            this.S = this.categoryNames.length;
        ...
        this.resize = function(width, height)  {
            ...
            if(this.debug) console.log('Index.resize()');
            ...
            this.pvBottomAxisRule.left(this.x);
            ...
            this.pvBottomAxisRule.data(function () { return localThis.x.ticks(labelCount); });
        ...
        this.update = function() {
            ...
            if(this.debug) console.log('Index.update()');
    ...
    //        if(this.debug) console.log('Index.update() rendering');
            this.vis.render();
        };

        /* Normalize the data according to an index point. */
        this.indexify = function(data, cols, idx) {
            if(this.debug) console.log('Index.indexing()');
            try {
                ...
                console.log('Index.indexing error: '+e.message);
            }
            if(this.debug) console.log('Index.indexing() done');
        };

        this.init = function() {

            if(this.debug) console.log('Index.init()');
    ...
    */
            ...
            /* Bottom axis */
            var visRule = this.pvBottomAxisRule = this.vis.add(pv.Rule);
            ...
            this.vis.add(pv.Panel)
              ...
              .add(pv.Line)
                ...
                .strokeStyle(function(d) { return localThis.colors[this.parent.index]; })
            ...
            this.rootPanel.add(pv.Dot)
                .data(function() { return this.parent.seriesNames; })
                    ...
                    .fillStyle(function(d) { return localThis.colors[this.index]; })
                    .strokeStyle(null)
                    .anchor("right")
                    .add(pv.Label)
            ...
            this.vis.add(pv.Panel)
                ...
                .event("mousemove", function() {
                    if(this.debug) console.log('Index mousemove');
                    localThis.idx = localThis.x.invert(
                              localThis.vis.mouse().x +
                              ((localThis.w - localThis.totalMarginWidth)/(localThis.categoryNames.length - 1) / 2)
                            ) >> 0;
                    localThis.update();
                });
        ...
        this.onCreate = function() {
            if(this.debug) console.log('Index.onCreate()');
            this.yAxisLabel = Messages.getString('yaxisTitle');
            this.titleBase = Messages.getString('titleBase');
