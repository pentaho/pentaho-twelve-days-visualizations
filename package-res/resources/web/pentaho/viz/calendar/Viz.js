...
define([
    ...
    "cdf/lib/CCC/tipsy"
], function(vizUtils, VizController, vizColorPalettes, pv, lang, Messages) {
    ...
    function Calendar(div) {
        ...
        this.backgroundcolorChanged = function(color) {
            ...
            if(this.debug) console.log('Calendar.color1Changed()');
        ...
        this.gradient1Changed = function(gradient) {
            if(this.debug) console.log('Calendar.gradient1Changed()',gradient);
            console.log('Calendar.gradient1Changed()',gradient);
        ...
        this.getState = function() {
            if(this.debug) console.log('Calendar.getState()');
            var state = {
        ...
        this.resize = function() {
            ...
            this.colors = vizColorPalettes.get().colors;
        ...
        this.getColor = function(d) {
            ...
            if(this.scalingType == "linear") {
                try {
                    color = vizUtils.getRgbGradientFromMultiColorHex(d.colorValue, this.colorMinValue, this.colorMaxValue, this.colorRange);
