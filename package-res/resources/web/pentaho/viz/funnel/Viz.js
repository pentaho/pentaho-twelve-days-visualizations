...
define([
    ...
    'dojo/_base/lang',
    'cdf/lib/CCC/tipsy'
], function(vizUtils, vizColorPaletteRegistry, $, pv, lang) {
    /*global cv:true*/
    ...
    function Funnel(div) {
        ...
        this.getState = function() {
            if(this.debug) console.log('Funnel.getState()');
            var state = {
        ...
        this.setState = function(state) {
            if(this.debug) console.log('Funnel.setState()');
        ...
        this.draw = function(dataTable, options) {
            ...
            var args;
            if(this.controller && this.controller.currentViz && (args = this.controller.currentViz.args)) {
                ...
                if(typeof args.pattern  != 'undefined' ||
                   typeof args.colorSet != 'undefined') {
                    ...
                    if(typeof args.colorSet != 'undefined') {
        ...
        this.resize = function() {
            ...
            /* Size parameters. */
            this.w = vizUtils.getClientWidth(this)-40;
            this.h = vizUtils.getClientHeight(this)-40;
