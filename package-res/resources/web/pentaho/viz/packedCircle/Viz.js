...
define([
    ...
    "dojo/_base/lang",
    "cdf/lib/CCC/tipsy"
], function(vizUtils, VizController, vizColorPaletteRegistry, vizEvents, $, pv, lang) {
    ...
    function PackedCircle(div) {
        ...
        this.getState = function() {
            if(this.debug) console.log('PackedCircle.getState()');
            var state = {
        ...
        this.setState = function(state) {
            if(this.debug) console.log('PackedCircle.setState()');
        ...
        this.getColor = function(d) {
            ...
            if(this.colorMode == 'top') {
                ...
                if(this.scalingType == "linear") {
                  try {
                   color = vizUtils.getRgbGradientFromMultiColorHex(d.nodeValue, this.minValue, this.maxValue, this.colorRange);
