...
define([
    ...
    "css!../table"
], function(vizUtils, vizColorPaletteRegistry, pv, lang, Messages) {
    /*global cv:true*/
    return Trellis;
    ...
    function Trellis(div) {
        ...
        this.colors = vizColorPaletteRegistry.get("twelveDaysViz").colors;
        this.showTable = true;
        this.highlights = [];
        ...
        this.getState = function() {
            if(this.debug) console.log('Trellis.getState()');
            var state = {
        ...
        this.setState = function(state) {
            if(this.debug) console.log('Trellis.setState()');
        ...
        this.draw = function(dataTable, options) {
            ...
            if(this.controller && this.controller.currentViz && this.controller.currentViz.args) {
                labelColor = this.controller.currentViz.args.labelColor;
                ...
                labelFontFamily = this.controller.currentViz.args.labelFontFamily;
                if(labelFontFamily && labelFontFamily != 'Default') { // TODO localize this?
                    this.labelFontFamily = labelFontFamily;
                }
                labelSize = this.controller.currentViz.args.labelSize;
                if(labelSize) {
                    this.labelSize = labelSize;
                }
                labelStyle = this.controller.currentViz.args.labelStyle;
                if(labelStyle && labelStyle != 'PLAIN') {
                    this.labelStyle = labelStyle;
                }
                backgroundType = this.controller.currentViz.args.backgroundType;
                if(backgroundType) {
                    this.backgroundType = backgroundType;
                }
                backgroundColor = this.controller.currentViz.args.backgroundColor;
                if(backgroundColor) {
                    this.backgroundColor = backgroundColor;
                }
                backgroundColorEnd = this.controller.currentViz.args.backgroundColorEnd;
            ...
            if(typeof cv !== 'undefined' && cv.rptEditor && cv.rptEditor.report && cv.rptEditor.report.reportDoc) {
                labelColor = cv.rptEditor.report.reportDoc.getChartOption('labelColor');
                if(labelColor) {
                    this.labelColor = labelColor;
                    this.controller.currentViz.args.labelColor = labelColor;
                }
                labelFontFamily = cv.rptEditor.report.reportDoc.getChartOption('labelFontFamily');
                if(labelFontFamily && labelFontFamily != 'Default') { // TODO localize this?
                    this.labelFontFamily = labelFontFamily;
                    this.controller.currentViz.args.labelFontFamily = labelFontFamily;
                }
                labelSize = cv.rptEditor.report.reportDoc.getChartOption('labelSize');
                if(labelSize) {
                    this.labelSize = labelSize;
                    this.controller.currentViz.args.labelSize = labelSize;
                }
                labelStyle = cv.rptEditor.report.reportDoc.getChartOption('labelStyle');
                if(labelStyle && labelStyle != 'PLAIN') {
                    this.labelStyle = labelStyle;
                    this.controller.currentViz.args.labelStyle = labelStyle;
                }
                backgroundType = cv.rptEditor.report.reportDoc.getChartOption('backgroundFill');
                if(backgroundType) {
                    this.backgroundType = backgroundType;
                    this.controller.currentViz.args.backgroundType = backgroundType;
                }
                backgroundColor = cv.rptEditor.report.reportDoc.getChartOption('backgroundColor');
                if(backgroundColor) {
                    this.backgroundColor = backgroundColor;
                    this.controller.currentViz.args.backgroundColor = backgroundColor;
                }
                backgroundColorEnd = cv.rptEditor.report.reportDoc.getChartOption('backgroundColorEnd');
                if(backgroundColorEnd) {
                    this.backgroundColorEnd = backgroundColorEnd;
            ...
            if(this.backgroundType == 'NONE') {
                ...
                if(div.style.background) {
                    back = "-moz-linear-gradient(top, "+this.backgroundColor+", "+this.backgroundColorEnd+")";
        ...
        this.resize = function() {
            ...
            if(this.showTable) {
                vizUtils.createSelectionTable(table, this.dataTable, this.labelFontStr, this.labelColor);
            }
        ...
        this.update = function(d, t) {
            ...
            if(this.showTable) {
                ...
                vizUtils.updateSelectionTable(table, this.dataTable, rows, this.labelFontStr, this.labelColor);
            }
        };
