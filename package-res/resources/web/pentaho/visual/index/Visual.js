...
define([
...
], function(utils, paletteRegistry, pv, Messages) {
    ...
    function Index(div) {
        ...
        this.draw = function(dataTable, drawSpec) {
            ...
            if(typeof drawSpec.bottomMargin === "number") {
                this.bottomMargin = drawSpec.bottomMargin;
                this.totalMarginHeight = this.topMargin + this.bottomMargin;
            }

            if(typeof drawSpec.rightMargin === "number") {
                this.rightMargin = drawSpec.rightMargin;
                this.totalMarginWidth = this.leftMargin + this.rightMargin;
            }
            ...
            this.h = utils.getClientHeight(this);
            this.S = this.categoryNames.length;
    ...
    //        if(this.debug) console.log('Index.update() rendering');
        ...
        this.init = function() {
            ...
            if(typeof this.drawSpec.rightMargin == 'number') {
            } else {
    ...
    */
            ...
            if(this.labelFontFamily && this.labelFontFamily != 'Default') {
